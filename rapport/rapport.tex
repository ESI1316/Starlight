...
Celle-ci possède des méthodes d'interractions avec une droite. Dans le contexte
présent, certains éléments du jeu seront des ellipse par le phénomène d'héritage
mis en place dans le paradigme orienté objet de C++.
...
segment droite est une partie de droite délimitée par deux points non confondus} 
...
cartésien\footnote{lien vers plan cartésien} : 
\begin{itemize}
...
La classe utilitaires mis en place ici est un ensemble de fonctions et valeurs
