...
``Catch''\footnote{Voir annexe~\ref{ref}}. Ses avantages
sont :
\begin{itemize}
...
\begin{enumerate}
	...
	\item \textbf{les couleurs} sont disponibles en fonction de la longueur d'onde du
		rayon\footnote{voir Annexe~\ref{ref}}
...
\begin{itemize}
	\item L'ensemble des sons disponibles dans \path{ressources/sounds}
		proviennent de \href{http://soundbible.com}{Sound
		bible} sous la license \href{http://soundbible.com}{Attribution 3.0
		License},
	\item l'icone a été dessiné par \textbf{Kriwin Paul} sous
		\href{http://www.gimp.org/}{Gimp}\footnote{Version. 2.8},
