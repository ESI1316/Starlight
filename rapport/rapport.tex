...
\section{C++}
Ce projet a été bati à l'aide de \textbf{Qt Creator
...
compatible 4.9). La norme ISO/IEC 14882:2011, aussi appellée c++11, est celle
utilisée. A cela s'ajoute certains ``flags'' de compilation
\begin{center}
\textbf{g++ -std=c++11 -Wextra -Wall -pedantic-errors}
\end{center}
\begin{itemize}
	\item -std=c++11 pour travailler en c++11,
	\item -Wextra qui nous permet d'avoir des messages d'avertissements,
	\item -Wall qui nous permet d'avoir tous les messages d'avertissements,
	\item -pedantic-errors qui transforme certains ``warnings'' en erreurs.
\end{itemize}
